...
type Fetcher interface {
	SourceType() string
	FindByID(ctx context.Context, id activitytypes.TypedUID, config *ProviderConfig) (Source, error)
	// Search can either:
	...
	Search(ctx context.Context, query string, config *ProviderConfig) ([]Source, error)
}
