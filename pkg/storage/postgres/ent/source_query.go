...
func (sq *SourceQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (sq *SourceQuery) FirstIDX(ctx context.Context) string {
...
func (sq *SourceQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (sq *SourceQuery) OnlyIDX(ctx context.Context) string {
...
func (sq *SourceQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (sq *SourceQuery) IDsX(ctx context.Context) []string {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
