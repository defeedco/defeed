...
func (fq *FeedQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (fq *FeedQuery) FirstIDX(ctx context.Context) string {
...
func (fq *FeedQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (fq *FeedQuery) OnlyIDX(ctx context.Context) string {
...
func (fq *FeedQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (fq *FeedQuery) IDsX(ctx context.Context) []string {
	ids, err := fq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (fq *FeedQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(feed.Table, feed.Columns, sqlgraph.NewFieldSpec(feed.FieldID, field.TypeString))
	_spec.From = fq.sql
